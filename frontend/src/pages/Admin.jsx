        ...
        <div className="card !p-0 overflow-x-auto">
          <table className="w-full min-w-[720px] text-sm">
            <thead className="bg-slate-50 text-xs uppercase text-slate-400 dark:bg-slate-800">
              <tr>
                <th className="px-3 py-2 text-left">ID / Mã</th>
              ...
              {users.map((u) => (
                <tr key={u.id}>
                  <td className="px-3 py-2 align-top">
                    <div className="font-mono text-xs font-bold text-shopee">
                      #{u.id}
                    </div>
                    <div
                      className="mt-0.5 font-mono text-[11px] text-slate-600 dark:text-slate-300"
                      title="Mã giới thiệu (ref)"
                    >
                      ref: <b>{u.referralCode || '—'}</b>
                    </div>
                    <div
                      className="mt-0.5 break-all font-mono text-[11px] text-sky-700 dark:text-sky-300"
                      title="sub_id trên short link / CSV Shopee"
                    >
                      sub: <b>{u.affSubId || `U${u.id}`}</b>
                    </div>
                  </td>
                  <td className="px-3 py-2">
      ...
      {tab === 'settings' && (
        ...
        >
          {[
            ...
            ['support_telegram', 'Telegram bot URL (https://t.me/...)'],
            ['support_telegram_bot', 'Telegram bot username (không @)'],
            ['support_zalo', 'Zalo support (SĐT hoặc link)'],
            ['support_zalo_group', 'Nhóm Zalo (https://zalo.me/g/...)'],
